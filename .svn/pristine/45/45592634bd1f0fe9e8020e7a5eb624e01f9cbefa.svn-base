...
Route::group(['middleware' => 'App\Http\Middleware\AdminMiddleware'], function()
{
	...
	Route::get('admin/add/admins', 'Auth\AuthController@addadmins');
	Route::post('admin/add/admins', 'Auth\AuthController@storeadmins');
	...
	Route::get('admin/news/all/{id}/delete', 'NewsController@show');
	Route::post('admin/news/all/{id}/delete', 'NewsController@destroy_all');
	...
	Route::post('admin/med-consulting/consulting', 'MedicalConsultingController@operations');

	Route::get('admin/med-consulting/consulting/all/{id}/delete', 'MedicalConsultingController@show_delete');
	Route::post('admin/med-consulting/consulting/all/{id}/delete', 'MedicalConsultingController@destroy');	
	...
	Route::get('admin/doctors/list/all/{id}/delete', 'DoctorController@show');
	Route::post('admin/doctors/list/all/{id}/delete', 'DoctorController@destroy_all');
	...
	Route::get('admin/banners/list/all/{id}/delete', 'BannerController@show');
	Route::post('admin/banners/list/all/{id}/delete', 'BannerController@destroy_all');
	...
	Route::get('admin/friendly-sites/list/all/{id}/delete', 'FriendlySitesController@show');
	Route::post('admin/friendly-sites/list/all/{id}/delete', 'FriendlySitesController@destroy_all');
	/**
	...
	Route::get('admin/pgallery/list/all/{id}/delete', 'GalleryController@show');
	Route::post('admin/pgallery/list/all/{id}/delete', 'GalleryController@destroy_all');
	/**
	 * Photo Gallery related routes (back-end)
	 *
	 */
	...
	Route::get('admin/vgallery/list/all/{id}/delete', 'VGalleryController@show');
	Route::post('admin/vgallery/list/all/{id}/delete', 'VGalleryController@destroy_all');
...
Route::get('pgallery/{id}', 'GalleryController@albums_list');
